...
PRESETS = {
    ...
    "alien-terrain-worms": {
        "kwargs": {
            ...
            "erosion_worms_alpha": .05 + random.random() * .0125,
            "erosion_worms_contraction": .75 + random.random() * .75,
            "erosion_worms_density": random.randint(200, 250),
            ...
            "ridges": True,
            "saturation": 2,
            "voronoi_alpha": 0.1 + random.random() * .05,
