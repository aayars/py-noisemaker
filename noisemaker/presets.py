...
PRESETS = {
    ...
    "alien-terrain-worms": {
        "kwargs": {
            ...
            "erosion_worms_alpha": .03 + random.random() * .015,
            "erosion_worms_contraction": 2,
            "erosion_worms_density": random.randint(75, 150),
            "erosion_worms_iterations": random.randint(50, 100),
            "freq": random.randint(2, 6),
            "hue_rotation": 0 if random.randint(0, 1) else random.random(),
            "hue_range": .125 + random.random() * .125,
            "saturation": 0.125 + random.random() * .125,
            "invert": random.randint(0, 1),
            "lattice_drift": 1,
            "octaves": 5,
            "point_freq": 10,
            ...
            "with_erosion_worms": True,
            "with_shadow": 1 + random.random() * .5,
            "with_voronoi": [1, 6][random.randint(0, 1)],
            "with_worms": 4,
            "worms_alpha": .125 + random.random() * .075,
