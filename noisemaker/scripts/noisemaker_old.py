...
def main(ctx, freq, width, height, channels, time, octaves, octave_blending,
    ...
    tensor = generators.multires_old(freq=freq, shape=shape, time=time, octaves=octaves, octave_blending=octave_blending,
                                     ...
                                     post_deriv=post_deriv, deriv=deriv, deriv_alpha=deriv_alpha,
