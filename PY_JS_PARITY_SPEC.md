...
The parity test suite stores SHA‑256 hashes of reference images that were
generated by the JavaScript implementation.  Run
`node test/parity/generate_hashes.js` to regenerate these fixtures and ensure
that Python's output remains byte‑identical.
